...
class DifferentCurrenciesSheet extends StatelessWidget {
  const DifferentCurrenciesSheet({super.key});
      ...
      child: Column(
        children: [
          ...
          Expanded(
            ...
            shrinkWrap: true,
            children: [
              incomeByCurrency(context, "ILS", "300.46"),
              incomeByCurrency(context, "USD", "450.23"),
              incomeByCurrency(context, "EUR", "220.5"),
              incomeByCurrency(context, "LRS", "107.4"),
            ],
          )),
          SizedBox(
            height: 5,
