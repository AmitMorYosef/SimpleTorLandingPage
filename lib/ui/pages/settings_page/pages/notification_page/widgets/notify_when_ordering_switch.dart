...
class NotifyWhileOrderingSwitch extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Switch(
          ...
          value: WorkerData.worker.notifyWhenGettingBooking,
          onChanged: (val) async {
            ...
            if (!val || context.read<DeviceProvider>().isAllowedNotification) {
              UiManager.updateUi(
                  context: context,
                  perform: Future(() =>
                      _workerProvider.updateNotifyWhenGettingBooking(val)));
            }
          }),
    );
  }
